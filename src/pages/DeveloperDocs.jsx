  ...
  return (
    ...
    >
      ...
      <p className="text-gray-600 text-lg mb-12">
        Find API references, integration guides, and best practices to make the most of the Sage platform.
      </p>
        ...
        {[1, 2, 3].map((i) => (
          ...
          >
            ...
            <p className="text-gray-500 mb-4">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vitae ligula non risus.
            </p>
            <button
