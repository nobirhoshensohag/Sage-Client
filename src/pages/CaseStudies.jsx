  ...
  return (
    ...
    >
      ...
      <p className="text-gray-600 text-lg mb-12">
        Explore detailed case studies showcasing insights, lessons, and real-world applications from our community.
      </p>
        ...
        {[1, 2, 3].map((i) => (
          ...
          >
            ...
            <p className="text-gray-500 mb-4">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec purus eget dolor facilisis tincidunt.
            </p>
            <button
